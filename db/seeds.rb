...
demo_housing1 = Housing.create(:name => "Beachfront Condo", :host_id => host_user.id, :address => "1 first street, city one, CA 12345 United States", :housing_type => "Entire place", :bedrooms => 2, :baths => 2, :beds => 2, :guests => 4, :price => 500)
demo_housing2 = Housing.create(:name => "Beachfront Room", :host_id => host_user.id, :address => "2 second street, city one, CA 12345 United States", :housing_type => "Private room", :bedrooms => 1, :baths => 1, :beds => 1, :guests => 2, :price => 50)
demo_housing3 = Housing.create(:name => "Beachfront Roommates", :host_id => host_user.id, :address => "3 third street, city one, CA 12345 United States", :housing_type => "Shared room", :bedrooms => 1, :baths => 1, :beds => 2, :guests => 2, :price => 30)
